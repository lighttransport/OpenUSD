@echo off
REM Run ns_dual tests on Windows for MONOLITHIC build
...
echo ========================================
echo USD Custom Namespace Tests - MONOLITHIC
echo ========================================
...
echo [Test 1] Testing pxr_lte only - MONOLITHIC
echo ----------------------------------------
...
if errorlevel 1 (
    ...
    echo Test 1 FAILED!
    echo.
    echo Make sure to build USD with custom namespace monolithic:
...
echo ========================================
echo [Test 2] Testing dual import - MONOLITHIC
echo ----------------------------------------
