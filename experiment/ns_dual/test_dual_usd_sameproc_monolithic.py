#!/usr/bin/env python3
"""
Test script for same-process dual USD usage (v26.05 MONOLITHIC).

This script demonstrates importing both standard USD (pxr) and custom
namespace USD (pxr_lte v26.05 monolithic) in the same Python process.
...
def test_imports():
    ...
    # Import custom namespace USD v26.05 (monolithic)
    print("\n2. Importing pxr_lte (custom namespace USD v26.05 MONOLITHIC)...")
    try:
...
def test_stage_creation(StandardUsd, CustomUsd):
    ...
    print("\n2. Creating custom namespace USD v26.05 stage (monolithic)...")
    try:
...
def test_independence(std_stage, custom_stage, StandardUsd, CustomUsd):
    ...
    print("\n2. Custom v26.05 (monolithic) stage prims:")
...
def test_export(std_stage, custom_stage):
    ...
    print("2. Custom USD v26.05 (monolithic) USDA output:")
    print("-" * 40)
...
def main():
    ...
    print("=" * 60)
    print("Same-Process Dual USD Test (v26.05 MONOLITHIC)")
    print("=" * 60)
    print()
    ...
    print(f"  pxr_lte (custom v26.05 monolithic): {CustomUsd.GetVersion()}")
    print("=" * 60)
