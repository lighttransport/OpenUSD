#!/usr/bin/env python3
"""
Test script for custom namespace USD only (pxr_lte) - MONOLITHIC BUILD.
...
def test_stage_creation():
    ...
    stage.SetMetadata("comment", "Test stage from pxr_lte monolithic")
...
def test_export():
    ...
    stage = Usd.Stage.CreateInMemory()
    stage.SetMetadata("comment", "Generated by pxr_lte monolithic test")
...
def main():
    ...
    print("=" * 60)
    print("pxr_lte Only Test (MONOLITHIC)")
    print("=" * 60)
    print()
    ...
    print(f"pxr_lte (monolithic) is working correctly.")
    print(f"  Version: {Usd.GetVersion()}")
    print("=" * 60)
