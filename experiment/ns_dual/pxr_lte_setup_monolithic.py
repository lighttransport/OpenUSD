...
Usage:
    ...
    pxr_lte_setup_monolithic.setup(
        custom_usd_root="C:/path/to/dist-usd-lte-monolithic-v24.11",
        tbb_root="C:/path/to/tbb"
    )
    from pxr_lte import Usd

Environment Variables:
    CUSTOM_USD_ROOT - Path to custom USD installation (default: ~/work/dist-usd-lte-monolithic-v24.11)
...
# Default paths for v24.11 MONOLITHIC build
DEFAULT_CUSTOM_USD_ROOT = Path.home() / "work" / "dist-usd-lte-monolithic-v24.11"
...
def setup(custom_usd_root=None, tbb_root=None, verbose=False):
    """Set up paths for custom namespace USD v24.11 (monolithic).
    ...
    Args:
        custom_usd_root: Path to custom USD installation.
                        Defaults to CUSTOM_USD_ROOT env var or ~/work/dist-usd-lte-monolithic-v24.11
    ...
    if verbose:
        print(f"Setting up pxr_lte paths (v24.11 MONOLITHIC):")
...
if __name__ == "__main__":
    ...
    print("pxr_lte_setup_monolithic - Dual USD Setup Helper (v24.11 MONOLITHIC)")
    print("=" * 60)
    ...
    if pxr_lte_ok:
        ...
        print()
        print("Build USD v24.11 with custom namespace (monolithic):")
