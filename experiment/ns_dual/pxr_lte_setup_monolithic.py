...
Usage:
    ...
    pxr_lte_setup_monolithic.setup(
        custom_usd_root="C:/path/to/dist-usd-lte-monolithic-v26.05",
        tbb_root="C:/path/to/tbb"
    )
    from pxr_lte import Usd

Environment Variables:
    CUSTOM_USD_ROOT - Path to custom USD installation (default: ~/work/dist-usd-lte-monolithic-v26.05)
...
# Default paths for v26.05 MONOLITHIC build
DEFAULT_CUSTOM_USD_ROOT = Path.home() / "work" / "dist-usd-lte-monolithic-v26.05"
...
def setup(custom_usd_root=None, tbb_root=None, verbose=False):
    """Set up paths for custom namespace USD v26.05 (monolithic).
    ...
    Args:
        custom_usd_root: Path to custom USD installation.
                        Defaults to CUSTOM_USD_ROOT env var or ~/work/dist-usd-lte-monolithic-v26.05
    ...
    if verbose:
        print(f"Setting up pxr_lte paths (v26.05 MONOLITHIC):")
...
if __name__ == "__main__":
    ...
    print("pxr_lte_setup_monolithic - Dual USD Setup Helper (v26.05 MONOLITHIC)")
    print("=" * 60)
    ...
    if pxr_lte_ok:
        ...
        print()
        print("Build USD v26.05 with custom namespace (monolithic):")
