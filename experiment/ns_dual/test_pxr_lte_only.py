#!/usr/bin/env python3
"""
Test script for custom namespace USD only (pxr_lte v24.11).
...
def test_stage_creation():
    ...
    stage.SetMetadata("comment", "Test stage from pxr_lte v24.11")
...
def test_export():
    ...
    stage = Usd.Stage.CreateInMemory()
    stage.SetMetadata("comment", "Generated by pxr_lte v24.11 test")
...
def main():
    ...
    print("=" * 60)
    print("pxr_lte Only Test (USD v24.11 Custom Namespace)")
    print("=" * 60)
    print()
    ...
    print(f"pxr_lte v24.11 is working correctly.")
    print(f"  Version: {Usd.GetVersion()}")
    print("=" * 60)
