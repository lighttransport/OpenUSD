@echo off
REM Build OpenUSD v26.05 with custom namespace (after configuration)
REM
...
echo ========================================
echo Building OpenUSD v26.05 (Custom Namespace)
echo ========================================
echo.
...
echo ========================================
echo Installing OpenUSD v26.05 (Custom Namespace)
echo ========================================
echo.
...
echo ========================================
echo Building and Installing OpenUSD v26.05
echo ========================================
echo.
echo Build directory:   %BUILD_DIR%
echo Install directory: %INSTALL_DIR%
...
echo ========================================
echo.
echo USD v26.05 installed to: %INSTALL_DIR%
echo.
