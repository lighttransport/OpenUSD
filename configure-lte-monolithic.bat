@echo off
REM Configure OpenUSD with custom namespace - MONOLITHIC BUILD
REM
REM This script only configures CMake - run build-lte-monolithic.bat to build.
REM
...
REM   - Monolithic:      ON (single lte_usd_ms library)
REM
...
set INSTALL_DIR=%SOURCE_DIR%\..\dist-usd-lte-monolithic
...
echo ========================================
echo Configuring OpenUSD - MONOLITHIC
echo ========================================
echo.
...
echo.
echo Or use build-lte-monolithic.bat to do both.
echo ========================================
