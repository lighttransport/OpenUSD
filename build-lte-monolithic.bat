@echo off
REM Build OpenUSD with custom namespace - MONOLITHIC BUILD
REM
...
REM
REM Usage:
REM   build-lte-monolithic.bat [configure|build|install|all|clean]
REM
...
echo Usage: build-lte-monolithic.bat [configure^|build^|install^|all^|clean]
exit /b 1
...
:print_header
echo ========================================
echo Building OpenUSD - MONOLITHIC
echo ========================================
echo.
...
echo   from pxr import Usd as StandardUsd      # Standard USD
echo   from %LTE_PYTHON_PACKAGE% import Usd as CustomUsd    # This build
echo.
