@echo off
REM Configure OpenUSD v26.05 with custom namespace - MONOLITHIC BUILD
REM
REM This script runs CMake configuration only. Run build-usd-lte-monolithic.bat after this.
REM
REM Monolithic build creates a single USD library instead of many separate libraries.
REM This simplifies deployment but increases build times and binary size.
REM
...
REM   - Monolithic library: single lte_usd_ms.dll
REM
REM Usage:
REM   configure-usd-lte-monolithic.bat [clean]
REM
...
echo ========================================
echo Configuring OpenUSD v26.05 - MONOLITHIC
echo ========================================
echo.
...
echo   Monolithic:      %BUILD_MONOLITHIC%
echo.
echo Paths:
...
echo [Configure] Running CMake configuration (Monolithic)...
echo.
...
cmake ^
    ...
    -DPXR_BUILD_MONOLITHIC=%BUILD_MONOLITHIC% ^
...
echo.
echo Next steps:
echo   1. Run build-usd-lte-monolithic.bat to build
echo   2. Run build-usd-lte-monolithic.bat install to install
echo.
echo Or run both:
