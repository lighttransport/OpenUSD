...
REM
REM Usage:
REM   build-usd-lte-monolithic.bat [build|install|all]
REM
...
REM ============================================================================
REM Configuration - Must match configure-usd-lte-monolithic.bat
REM ============================================================================
...
echo Usage: build-usd-lte-monolithic.bat [build^|install^|all]
exit /b 1
...
if not exist "%BUILD_DIR%\CMakeCache.txt" (
    ...
    echo.
    echo Run configure-usd-lte-monolithic.bat first.
    exit /b 1
)
...
echo ========================================
echo.
echo Next step: Run 'build-usd-lte-monolithic.bat install' to install.
echo ========================================
cd /d "%SCRIPT_DIR%"
goto :end
...
echo ========================================
echo Building and Installing - MONOLITHIC
echo ========================================
echo.
echo Build directory:   %BUILD_DIR%
echo Install directory: %INSTALL_DIR%
...
echo   Monolithic:      ON (single library)
echo.
