...
# USD build script with default PXR namespace
# - Default namespace: pxr
...
echo "========================================="
echo "USD PXR Build Configuration"
echo "========================================="
echo "Install Directory: ${INSTALL_DIR}"
echo "Build Type: ${BUILD_TYPE}"
echo "Parallel Jobs: ${NUM_CORES}"
echo "Default Namespace: pxr"
echo "========================================="
...
python "${SCRIPT_DIR}/build_scripts/build_usd.py" \
    ...
    --build-args USD,"-DPXR_ENABLE_PYTHON_SUPPORT=TRUE -DPXR_BUILD_IMAGING=FALSE -DPXR_BUILD_USD_TOOLS=FALSE -DPXR_BUILD_TESTS=FALSE" \
    -j ${NUM_CORES} \
    --no-imaging \
    --no-examples \
    --no-tutorials \
